...
Important (Should)
The user should be able to enter ingredients they want to exclude from the search results.
The user should be able to enter a calorie range.
The user should be able to enter the cuisine type (e.g., Italian, Indian).

Suggested (Could)
The search results should show the cooking time (if available).
The search results should show the number of servings (if available).
The list of recipes in the results should be numbered.
The results should include a shopping list (all ingredients needed for a particular recipe).
The results should be saved in a file.

Avoid (Won't)
The user should be able to select the main ingredient (if not all ingredients are found,
the search focuses on the main ingredient).
The user should be able to enter the number of servings they want.
The program should check for misspelled words in user input and suggest corrections -
implemented but removed due to complexity.
The user should be able to bookmark the recipes they want (add to favorites).
The results should contain links to cooking videos.
If some ingredients are not found, the program should offer substitutions.
"""
